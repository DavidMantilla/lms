		...
		<div class="row">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item"><a class="nav-link " href="index.php"><em class="fa fa-home"></em>Inicio <span class="sr-only">(current)</span></a></li>
						<li class="nav-item"><a class="nav-link " href="Clases.php"><em class="fa fa-book"></em>Clases <span class="sr-only">(current)</span></a></li>
			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					...
					<section align="left">
					<br><br>
					<div class="col-md-12" style="text-align:left"><?php  $personas->verperfil($_SESSION["user"]);?>
					
					<a href="../lib/imprimir.php" class="btn btn-primary" >Imprimir</a>
					</div>	
				</section>
			</main>
		</div>
